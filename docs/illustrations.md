...
!!! warning "埋め込みが表示されない場合"
    Xの埋め込みが正しく表示されない場合は、ページを再読み込みしてください。
...
??? note "展開"
    ...
    {{ twitter("https://x.com/umamochi_shiro/status/1905196465896726643") }}

    ### 見せられないよ！（2025/03/24）

    {{ twitter("https://x.com/umamochi_shiro/status/1904082123377844532") }}

    ### ハッピーバレンタイン（2025/02/14）

    {{ twitter("https://x.com/umamochi_shiro/status/1890324106345681024") }}
...
??? note "展開"
    ...
    - [おえかき配信 その①](https://www.youtube.com/watch?v=_1JFydytayE)
    - [おえかき配信 その②](https://www.youtube.com/watch?v=N27R3S2KQlw)

    ### 初期衣装（2024/11/27）

    {{ twitter("https://x.com/umamochi_shiro/status/1861734894583664994") }}

    ### プロフィール画像（2024/09/19）

    {{ twitter("https://x.com/umamochi_shiro/status/1836741571439624310") }}

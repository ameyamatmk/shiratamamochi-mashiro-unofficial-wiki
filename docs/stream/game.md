...
| # | サムネイル | 配信日 | タイトル |
|:---:|:----------:|--------|----------|
| 2 | {{ youtube_thumbnail("w6pcM9y3jOk") }} | 2025/05/18 | ローリエさんと仲良くなりたいなぁ |
| 3 | {{ youtube_thumbnail("4k5PuwVR8Ic") }} | 2025/05/21 | おねショタって…最高 |
| 4 | {{ youtube_thumbnail("9hjB_nqS9Kk") }} | 2025/05/25 | 農業も釣りも恋愛もがんばりたい |
| 5 | {{ youtube_thumbnail("yLPB0uqus2I") }} | 2025/05/28 | 憧れの女性とたくさんデートがしたいです！ |
| 6 | {{ youtube_thumbnail("Ud66whyEHrU") }} | 2025/06/01 | ついにローリエさんに告白…できるのか・・・!? |
| 7 | {{ youtube_thumbnail("AlzF-ENCTA8") }} | 2025/06/04 | ついに憧れの女性とお付き合いすることになりました♡ |

#### ましろ、運命の女性と出会う【白玉餅ましろ切り抜き】

{{ youtube_thumbnail("dlzlzng1AIA", 320) }}
...
| # | サムネイル | 配信日 | タイトル |
|:---:|:----------:|--------|----------|
| 2 | {{ youtube_thumbnail("Yv3JFJUv0gc") }} | 2025/07/02 | これが青春か～～！ |
| 3 | {{ youtube_thumbnail("ZXBbMgcK5XU") }} | 2025/07/09 | みんなかわいすぎる・・・ |
| 4 | {{ youtube_thumbnail("3hyoJK-IkVU") }} | 2025/07/13 | 誰のルートに行くのかな…!? |
| 5 | {{ youtube_thumbnail("mtqbb1Kumyk") }} | 2025/07/20 | 修学旅行があるらしいですよ！(ノーマルエンド…？) |
| 6 | {{ youtube_thumbnail("rgpNinpEKp0") }} | 2025/07/29 | ついにレミィルートに辿り着いた・・・！ |
...
| # | サムネイル | 配信日 | タイトル |
|:---:|:----------:|--------|----------|
| 2 | {{ youtube_thumbnail("FRKERkfGm4A") }} | 2025/08/10 | 今年の夏休み、素敵な親戚のお姉さんと暮らします♡ |
| 3 | {{ youtube_thumbnail("OckmPtiFNS8") }} | 2025/08/13 | お姉さんによしよしされたいです！ |
| 4 | {{ youtube_thumbnail("SuXucwiQOpQ") }} | 2025/08/16 | こんな夏休み、過ごしたかった… |
| 5 | {{ youtube_thumbnail("c-mht-NbL6o") }} | 2025/08/21 | まだ終わらない、今年の夏休み |
| 6 | {{ youtube_thumbnail("smjButU7Vzw") }} | 2025/08/24 | なんてことない夏のいなかのものがたり。🌻 |
...
{{ youtube_thumbnail("https://www.youtube.com/watch?v=4GGiKBfGvQw", 320) }}
...
[:simple-youtube: 再生リスト](https://www.youtube.com/playlist?list=PLno8GgQ6NQv3yK9BCquefAvadQ4NjMrUc){ .md-button }

#### ＃１　夜の散歩に行きましょうか…🌃

{{ youtube_thumbnail("https://www.youtube.com/watch?v=tPapCu3PKoE", 320) }}
...
| 3 | {{ youtube_thumbnail("TQB6vdYVJV0") }} | 2026/05/14 | Coffee Talk ＃３ |
| 4 | {{ youtube_thumbnail("K3Q11diC1Ts") }} | 2026/05/20 | Coffee Talk ＃４（終） |
